...
function serveFile(relativePath, res) {
  ...
  if (!fs.existsSync(filePath) || !fs.statSync(filePath).isFile()) {
    ...
    res.end(
      '<!DOCTYPE html><title>404</title><h1>File not found</h1><p><a href="/landing">Go to landing</a></p>'
    );
    return;
  }
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('  Extensionless HTML paths resolve automatically (e.g. /landing, /index)');
});
